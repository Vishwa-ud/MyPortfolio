...
const Island = ({isRotating, setIsRotating, setCurrentStage, ...props}) => {
    ...
    const handlePointerDown = (e) => {
        ...
        const clienX = e.touches ? e.touches[0].clientX : e.clientX;
        lastX.current = clienX;
    }
    ...
    useFrame(() => {
      if (!isRotating) {
        ...
        // Update the island's rotation based on the rotation speed
    ...
    // useEffect(() => {
    //     const cleanup = useGLTF.preload(islandScene);
    //     return cleanup;
    //   }, []);
